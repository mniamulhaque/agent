                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                ...
                                @elseif($menuGurd == "pendinglist")
                                <a class="dropdown-item" href="{{url('/fileCompleted/'.$frow->id)}}">Completed</a>
                                <a class="dropdown-item" href="{{url('/fileDeactive/'.$frow->id)}}">Deactive</a>
                                <a class="dropdown-item" href="{{url('/fileCancle/'.$frow->id)}}">Cancle</a>
                                @endif
                                @if($menuGurd == "completedlist")
                                @else
